...
Here's the pseudocode for our problem. Your task is to fill out the code, run it, report the answer and then push it back to me using the repository that was created when you accepted this 'assignment' via the invitation you received from github.
...
It would better still to keep each distance in a vector and then plot a histogram of its distribution.
